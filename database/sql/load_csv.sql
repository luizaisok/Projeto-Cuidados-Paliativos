...
-- usuarios
LOAD DATA LOCAL INFILE './data/csv/usuarios.csv'
INTO TABLE usuarios
...
-- pacientes
LOAD DATA LOCAL INFILE './data/csv/pacientes.csv'
...
-- cuidadores
LOAD DATA LOCAL INFILE './data/csv/cuidadores.csv'
...
LOAD DATA LOCAL INFILE './data/csv/paciente_cuidador.csv'
